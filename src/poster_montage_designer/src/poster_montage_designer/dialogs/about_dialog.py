...
class AboutCard(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None, *, show_close: bool = False) -> None:
        ...
        quick_start = QLabel(
            "<b>Quick start</b><br>"
            "1. Add your TMDb token in Settings.<br>"
            "2. Import your IMDb filmography.<br>"
            "3. Arrange, customise and export.",
            self,
        )
        quick_start.setWordWrap(True)
        text_layout.addWidget(quick_start)
...
class AboutDialog(QDialog):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setModal(True)
        self.setFixedSize(648, 458)
        layout = QVBoxLayout(self)
        layout.setContentsMargins(14, 14, 14, 14)
        card = AboutCard(self, show_close=True)
        card.user_guide_requested.connect(self._open_user_guide)
